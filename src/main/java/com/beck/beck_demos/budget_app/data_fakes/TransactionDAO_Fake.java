...
public class TransactionDAO_Fake implements iTransactionDAO {
  ...
  public TransactionDAO_Fake(){
    ...
    Transaction transaction6 = new Transaction("yFdcNrQjXxtdYmVMXxtdYmVMXxtdYmVMXxtd", 64, "PVEswhXn", "QakFsBmw", new Date(104,4,4), 16, "jPmIJfXo", 16.21, "vuoEajRS", "HTBrTAln",false);
    Transaction transaction7 = new Transaction("uNflmsKjXxtdYmVMXxtdYmVMXxtdYmVMXxtd", 22, "PVEswhXn", "wZvoDKnV", new Date(104,4,4), 32, "lXJeJiol", 52.11, "WZHXraZJ", "BIuspOlq",false);
    Transaction transaction8 = new Transaction("VkbDBwHTXxtdYmVMXxtdYmVMXxtdYmVMXxtd", 55, "oCESkdTM", "VSQpEweA", new Date(104,4,4), 60, "TWWqErRX", 39.51, "kxwGAKmW", "woRyoFcX",false);
    Transaction transaction9 = new Transaction("JqXLFMvfXxtdYmVMXxtdYmVMXxtdYmVMXxtd", 47, "BPRebbnT", "VSQpEweA", new Date(104,4,4), 12, "CHpsZCmf", 55.61, "qsFNeSmq", "tEjHmMeK",false);
    Transaction transaction10 = new Transaction("jXRRwPVGXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 53, "aSfJIwAr", "VSQpEweA", new Date(104,4,4), 21, "WMWvOjvc", 25.87, "RuTUfnqD", "FTZsciHu",false);
    Transaction transaction11 = new Transaction("kZLjumHuXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 27, "pXnmIbVT", "VSQpEweA", new Date(104,4,4), 10, "EKVMfqSE", 61.11, "fXQmOAPj", "sTnYEpVD",false);
    Transaction transaction12 = new Transaction("wlEcdvnUXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 26, "WpvyCtle", "RfZfaVvH", new Date(104,4,4), 59, "OntsTkKs", 29.34, "ZxUbTuFm", "RYFvDdXx",false);
    Transaction transaction13 = new Transaction("sIBBbJNrXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 26, "ALSgpQxI", "xCACCyjQ", new Date(104,4,4), 46, "YtfNolpT", 38.51, "llquSLdd", "IHmFdUvt",false);
    Transaction transaction14 = new Transaction("XjYIPbdLXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 26, "ZGTodgXQ", "OKGWFxnl", new Date(104,4,4), 41, "ZjOMLauk", 17.9, "cPQPsiPT", "FgMVKoWA",false);
    Transaction transaction15 = new Transaction("eZTCJKPuXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 26, "nNhvQhku", "pNWYBUDC", new Date(104,4,4), 60, "AjKuGgOy", 23.2, "GnhYbFoJ", "VdOyINxo",false);
    Transaction transaction16 = new Transaction("CmpcYkijXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 36, "DBoXIYtE", "owsDSMKg", new Date(104,4,4), 41, "MlkCXriZ", 65.73, "LQWAgWCB", "SmErOigP",false);
    Transaction transaction17 = new Transaction("FlknekdMXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 18, "DBoXIYtE", "SAUwtypY", new Date(104,4,4), 12, "OwLfQKqt", 35.82, "ULSjbcgK", "WffvnEBg",false);
    Transaction transaction18 = new Transaction("VrFCCpfYXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 29, "DBoXIYtE", "sFZdmpLq", new Date(104,4,4), 66, "qhdUQReG", 56.88, "WSJgaOBT", "RJffRPjb",false);
    Transaction transaction19 = new Transaction("jmsokvbMXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 30, "DBoXIYtE", "CAbmXuCP", new Date(104,4,4), 15, "JLLFQoql", 21.68, "BRFjtTta", "bMFTtYtN",false);
    Transaction transaction20 = new Transaction("sWoBSjuBXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 12, "bIivGJRd", "cVMGDgbA", new Date(104,4,4), 58, "VQebeFxB", 50.8, "UfRaipPS", "bkXWfgiK",false);
    Transaction transaction21 = new Transaction("XsMDmdbkXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 27, "ZgevAUIu", "cVMGDgbA", new Date(104,4,4), 59, "HnFpqjsO", 68.53, "mOrHwWnc", "nIcvHFxr",false);
    Transaction transaction22 = new Transaction("tGdWIOjeXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 42, "uFaBKenY", "cVMGDgbA", new Date(104,4,4), 29, "iOIWaASQ", 21.64, "gArypmda", "eAHYiBme",false);
    Transaction transaction23 = new Transaction("YyQSbKqAXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 45, "NXTTNEiC", "cVMGDgbA", new Date(104,4,4), 50, "WtEJQpQm", 36.79, "UmUtRtTX", "RYeuJaCl",false);
    Transaction transaction24 = new Transaction("IENdRkxBXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 53, "FMIFPjsE", "BensCZsg", new Date(104,4,4), 34, "cBkGjgMp", 13.03, "CVsLgKRC", "hkpHvOrM",false);
    Transaction transaction25 = new Transaction("GeTvtHwTXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 53, "jCViDgKb", "kdpmhVUu", new Date(104,4,4), 26, "fcarqTbL", 63.48, "IuYTrwIv", "TeEQvTVc",false);
    Transaction transaction26 = new Transaction("QqeaMgsjXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 53, "JJVFTRZp", "DQxpZBPL", new Date(104,4,4), 31, "fMUjPjaS", 46.29, "ilZHmxXw", "HxwetfRS",false);
    Transaction transaction27 = new Transaction("SBFHvDvnXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 53, "BeNVmxpH", "RppCaBDI", new Date(104,4,4), 23, "WBRiKXvh", 38.11, "LFlQuDqJ", "WSsbKgDy",false);
    Transaction transaction28 = new Transaction("FqNRhRlkXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 31, "yFZmNHCd", "AtmLWekO", new Date(104,4,4), 48, "MUOJKuhv", 16.26, "fyCmAMDF", "bsstSKxb",false);
    Transaction transaction29 = new Transaction("inHhcuhVXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 66, "yFZmNHCd", "fRpAUfEV", new Date(104,4,4), 68, "HlySFegk", 30.3, "uyLTksne", "wZrSpHrm",false);
    Transaction transaction30 = new Transaction("ksNNnAZwXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 59, "yFZmNHCd", "oVCqqbNw", new Date(104,4,4), 37, "xFGaBHtP", 35.88, "IKMruqpM", "hKKsnEyP",false);
    Transaction transaction31 = new Transaction("tcbQFVKXXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 58, "yFZmNHCd", "flwLGtKf", new Date(104,4,4), 47, "IKuAlAlm", 26.51, "FQCalMRw", "yTmAoDPF",false);
    Transaction transaction32 = new Transaction("UGjhbEcXXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 18, "hUiVZscL", "sBbQihPX", new Date(104,4,4), 20, "rcTGftry", 21.19, "aXAeMecU", "OKcgUtVa",false);
    Transaction transaction33 = new Transaction("hhKFllcCXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 50, "fFXuaQUE", "sBbQihPX", new Date(104,4,4), 19, "oVyJkvhy", 50.41, "kkVXnVvu", "GZrsahnI",false);
    Transaction transaction34 = new Transaction("lhFEQTlSXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 51, "BjJplFqQ", "sBbQihPX", new Date(104,4,4), 18, "QhuGKUZx", 52.52, "vXvmuRag", "LNBeJFUL",false);
    Transaction transaction35 = new Transaction("kPhlBQapXxtdYmVMXxtdYmVMXxtdYmVMXxtm", 44, "uiFSepoQ", "sBbQihPX", new Date(104,4,4), 43, "mVuKEsOC", 55.51, "BoJhhBJH", "tXSEjfwF",false);
