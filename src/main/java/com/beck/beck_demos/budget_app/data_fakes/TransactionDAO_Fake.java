...
public class TransactionDAO_Fake implements iTransactionDAO {
  ...
  public TransactionDAO_Fake(){
    ...
    Transaction transaction1 = new Transaction("ukukySnYXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "618052e9-c69b-4d9b-880e-e22e4a970bd6", "89b27815-99d5-45a8-94f4-63305b82875b", "DZruQsNI", new Date(104,4,4), 41, "xCasey", 59.31, "tuuNNIrl", "ADZCjFxl",true);
    Transaction transaction2 = new Transaction("AbgcYOYUXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "618052e9-c69b-4d9b-880e-e22e4a970bd6", "a6e4d29a-5026-4d08-8f64-46c59368d904", "MdlXXIxq", new Date(104,4,4), 62, "Casey", 24.12, "snltZGLJ", "InhoYwkH",false);
    Transaction transaction3 = new Transaction("OCKMacGkXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "618052e9-c69b-4d9b-880e-e22e4a970bd6", "02a94565-d01a-466d-8526-17b51b2e2d83", "YrrxQPxo", new Date(104,4,4), 13, "KRfWlDSH", 11.36, "YwMJnuUm", "LEtOqAPS",false);
    Transaction transaction4 = new Transaction("BFBLAaRwXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "618052e9-c69b-4d9b-880e-e22e4a970bd6", "d406734c-6028-442a-9e1e-289b53f66a6a", "jLiECvmj", new Date(104,4,4), 18, "vVDgNOEv", 26.08, "hlysPkyD", "SwsBHRBv",false);
    Transaction transaction5 = new Transaction("hwVSiwiSXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "3b355d50-e85d-4956-a4c3-2d93e18a9370", "CsCZwEIf", new Date(104,4,4), 53, "nfoybZov", 65.91, "VMRcORSQ", "gTnPkAuA",false);
    Transaction transaction6 = new Transaction("yFdcNrQjXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "c9540b68-450b-4d32-8e1e-08c3472097e8", "QakFsBmw", new Date(104,4,4), 16, "jPmIJfXo", 16.21, "vuoEajRS", "HTBrTAln",false);
    Transaction transaction7 = new Transaction("uNflmsKjXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "f8b7e226-7a76-48a0-8025-095594b283d5", "wZvoDKnV", new Date(104,4,4), 32, "lXJeJiol", 52.11, "WZHXraZJ", "BIuspOlq",false);
    Transaction transaction8 = new Transaction("VkbDBwHTXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "862a9391-7643-4f96-bd76-a070e704149d", "VSQpEweA", new Date(104,4,4), 60, "TWWqErRX", 39.51, "kxwGAKmW", "woRyoFcX",false);
    Transaction transaction9 = new Transaction("JqXLFMvfXxtdYmVMXxtdYmVMXxtdYmVMXxtd", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "1e550c60-f001-4470-a35c-29367d025b42", "VSQpEweA", new Date(104,4,4), 12, "CHpsZCmf", 55.61, "qsFNeSmq", "tEjHmMeK",false);
    Transaction transaction10 = new Transaction("jXRRwPVGXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "b548b894-3a57-4184-9844-309176315664", "VSQpEweA", new Date(104,4,4), 21, "WMWvOjvc", 25.87, "RuTUfnqD", "FTZsciHu",false);
    Transaction transaction11 = new Transaction("kZLjumHuXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "2d2e8b28-1114-419b-980b-22f7b8d80f84", "VSQpEweA", new Date(104,4,4), 10, "EKVMfqSE", 61.11, "fXQmOAPj", "sTnYEpVD",false);
    Transaction transaction12 = new Transaction("wlEcdvnUXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "997b87f0-29c4-4a41-86d5-a3350285a29c", "RfZfaVvH", new Date(104,4,4), 59, "OntsTkKs", 29.34, "ZxUbTuFm", "RYFvDdXx",false);
    Transaction transaction13 = new Transaction("sIBBbJNrXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "44763ca9-b0a4-4fd2-9fc7-cf973c3a6af8", "720c7410-67d1-4286-9f8d-4e292850904d", "xCACCyjQ", new Date(104,4,4), 46, "YtfNolpT", 38.51, "llquSLdd", "IHmFdUvt",false);
    Transaction transaction14 = new Transaction("XjYIPbdLXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "c6f21228-a461-4608-8e68-04f86016e159", "OKGWFxnl", new Date(104,4,4), 41, "ZjOMLauk", 17.9, "cPQPsiPT", "FgMVKoWA",false);
    Transaction transaction15 = new Transaction("eZTCJKPuXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "f5509b55-6677-4022-8750-f19e48b81665", "pNWYBUDC", new Date(104,4,4), 60, "AjKuGgOy", 23.2, "GnhYbFoJ", "VdOyINxo",false);
    Transaction transaction16 = new Transaction("CmpcYkijXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "42337e73-90d2-4303-91b4-e350586e3508", "owsDSMKg", new Date(104,4,4), 41, "MlkCXriZ", 65.73, "LQWAgWCB", "SmErOigP",false);
    Transaction transaction17 = new Transaction("FlknekdMXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "66708757-7988-4444-933e-d98c09d3780a", "SAUwtypY", new Date(104,4,4), 12, "OwLfQKqt", 35.82, "ULSjbcgK", "WffvnEBg",false);
    Transaction transaction18 = new Transaction("VrFCCpfYXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "5a766c6b-9523-424a-9357-5509e51c68e3", "sFZdmpLq", new Date(104,4,4), 66, "qhdUQReG", 56.88, "WSJgaOBT", "RJffRPjb",false);
    Transaction transaction19 = new Transaction("jmsokvbMXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "705c92c5-78e2-4113-902e-836798e974e6", "CAbmXuCP", new Date(104,4,4), 15, "JLLFQoql", 21.68, "BRFjtTta", "bMFTtYtN",false);
    Transaction transaction20 = new Transaction("sWoBSjuBXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "96637841-4c15-4674-8d48-31298c9287c9", "cVMGDgbA", new Date(104,4,4), 58, "VQebeFxB", 50.8, "UfRaipPS", "bkXWfgiK",false);
    Transaction transaction21 = new Transaction("XsMDmdbkXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "190f8983-4a15-4e76-80d5-316270929729", "cVMGDgbA", new Date(104,4,4), 59, "HnFpqjsO", 68.53, "mOrHwWnc", "nIcvHFxr",false);
    Transaction transaction22 = new Transaction("tGdWIOjeXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "034360e2-886d-473d-9051-409170248559", "cVMGDgbA", new Date(104,4,4), 29, "iOIWaASQ", 21.64, "gArypmda", "eAHYiBme",false);
    Transaction transaction23 = new Transaction("YyQSbKqAXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "a0535359-5753-483d-9041-356973648580", "cVMGDgbA", new Date(104,4,4), 50, "WtEJQpQm", 36.79, "UmUtRtTX", "RYeuJaCl",false);
    Transaction transaction24 = new Transaction("IENdRkxBXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "6c368367-3316-4c31-8931-102146908356", "BensCZsg", new Date(104,4,4), 34, "cBkGjgMp", 13.03, "CVsLgKRC", "hkpHvOrM",false);
    Transaction transaction25 = new Transaction("GeTvtHwTXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "980b3ed6-9db7-4704-a6bc-1e90d5745a35", "96c68360-1216-4c12-8831-294146908356", "kdpmhVUu", new Date(104,4,4), 26, "fcarqTbL", 63.48, "IuYTrwIv", "TeEQvTVc",false);
    Transaction transaction26 = new Transaction("QqeaMgsjXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "4f88f943-c3b8-4b32-9136-9e7c2a2ddbfc", "380c8501-4470-4927-a991-872f2a7dd73a", "DQxpZBPL", new Date(104,4,4), 31, "fMUjPjaS", 46.29, "ilZHmxXw", "HxwetfRS",false);
    Transaction transaction27 = new Transaction("SBFHvDvnXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "4f88f943-c3b8-4b32-9136-9e7c2a2ddbfc", "78208757-7988-4444-933e-d98c09d3780a", "RppCaBDI", new Date(104,4,4), 23, "WBRiKXvh", 38.11, "LFlQuDqJ", "WSsbKgDy",false);
    Transaction transaction28 = new Transaction("FqNRhRlkXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "4f88f943-c3b8-4b32-9136-9e7c2a2ddbfc", "9a766c6b-9523-424a-9357-5509e51c68e3", "AtmLWekO", new Date(104,4,4), 48, "MUOJKuhv", 16.26, "fyCmAMDF", "bsstSKxb",false);
    Transaction transaction29 = new Transaction("inHhcuhVXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "4f88f943-c3b8-4b32-9136-9e7c2a2ddbfc", "205c92c5-78e2-4113-902e-836798e974e6", "fRpAUfEV", new Date(104,4,4), 68, "HlySFegk", 30.3, "uyLTksne", "wZrSpHrm",false);
    ...
    Transaction transaction33 = new Transaction("hhKFllcCXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "4f88f943-c3b8-4b32-9136-9e7c2a2ddbfc", "c0535359-5753-483d-9041-356973648580", "sBbQihPX", new Date(104,4,4), 19, "oVyJkvhy", 50.41, "kkVXnVvu", "GZrsahnI",false);
    Transaction transaction34 = new Transaction("lhFEQTlSXxtdYmVMXxtdYmVMXxtdYmVMXxtm", "4f88f943-c3b8-4b32-9136-9e7c2a2ddbfc", "5c368367-3316-4c31-8931-102146908356", "sBbQihPX", new Date(104,4,4), 18, "QhuGKUZx", 52.52, "vXvmuRag", "LNBeJFUL",false);
