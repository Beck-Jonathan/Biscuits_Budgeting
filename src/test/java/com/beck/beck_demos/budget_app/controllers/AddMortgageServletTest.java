...
public class AddMortgageServletTest {
  ...
  public void TestAddCanAddWithNoErrorsAndRedirects() throws ServletException, IOException{
    ...
    request.setParameter("inputmortgagePresent_Value","100000");
    request.setParameter("inputmortgageFuture_Value","83930.05");
    request.setParameter("inputmortgageInterest_Rate","3.5");
    request.setParameter("inputmortgageMonthly_Payment","1000");
    request.setParameter("inputmortgageExtra_Payment","0");
    request.setParameter("inputmortgageRemaining_Term","22");
    servlet.doPost(request,response);
    int responseStatus = response.getStatus();
    Map<String, String> results = (Map<String, String>) request.getAttribute("results");
