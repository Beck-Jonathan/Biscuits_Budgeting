...
public class AllSuggestionServletTest {
  private static final String PAGE="WEB-INF/schedule_app/All_Suggestion.jsp";
  AllSuggestionServlet servlet;
  ...
  public void setup() throws ServletException{
    ...
    servlet = new AllSuggestionServlet();
  ...
  /**
   <p> Test that a logged in user is able to retreive all of the Suggestion objects. </p>
   */
  @Test
  public void testLoggedInUserGetsAllSuggestions() throws ServletException, IOException{
    User user = new User();
    List<String> roles = new ArrayList<>();
    roles.add("User");
    user.setRoles(roles);
